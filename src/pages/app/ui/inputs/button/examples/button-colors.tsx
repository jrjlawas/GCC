    ...
    <Grid size={12}>
      <Card>
        <CardContent>
          ...
          <Box className="row mb-4 flex flex-wrap items-start gap-2">
            <Button color="accent-5" variant="contained">
              Accent 5
            </Button>
            <Button color="accent-5" variant="outlined">
              Accent 5
            </Button>
            <Button color="accent-5" variant="pastel">
              Accent 5
            </Button>
            <Button color="accent-5" variant="text">
              Accent 5
            </Button>
            <Button color="accent-5" variant="surface">
              Accent 5
            </Button>
          </Box>
          <Box className="row mb-4 flex flex-wrap items-start gap-2">
            <Button color="accent-6" variant="contained">
              Accent 6
            </Button>
            <Button color="accent-6" variant="outlined">
              Accent 6
            </Button>
            <Button color="accent-6" variant="pastel">
              Accent 6
            </Button>
            <Button color="accent-6" variant="text">
              Accent 6
            </Button>
            <Button color="accent-6" variant="surface">
              Accent 6
            </Button>
          </Box>
          <Box className="row mb-4 flex flex-wrap items-start gap-2">
