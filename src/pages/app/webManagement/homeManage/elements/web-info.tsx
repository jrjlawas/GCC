...
export default function WebInfo() {
  ...
  const [productInfo, setProductInfo] = useState<ProductInfoData>({
    ...
    description:
      "Handcrafted wooden toy made from premium, eco-friendly materials.",
