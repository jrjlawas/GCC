...
export default function User() {
  ...
  const fname = userString ? JSON.parse(userString).firstname : null;
  const lname = userString ? JSON.parse(userString).lastname : null;
  const mail = userString ? JSON.parse(userString).email : null;
  const handleToggle = () => {
